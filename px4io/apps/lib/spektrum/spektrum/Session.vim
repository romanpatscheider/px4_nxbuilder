...
silent only
cd ~/src/px4_nxbuilder/px4fmu/apps/spektrum
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 nuttx_spektrum.h
badd +0 nuttx_spektrum.c
badd +87 spektrum_test.c
badd +0 Makefile
args nuttx_spektrum.h
...
262
normal zo
let s:l = 180 - ((10 * winheight(0) + 32) / 64)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 70 - ((52 * winheight(0) + 32) / 64)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
70
...
86
normal zo
let s:l = 126 - ((46 * winheight(0) + 32) / 64)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
126
